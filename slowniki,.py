...
print(oceny['fizyka']) #Pobieramy wartośćprzypisaną do klucza 'fizyka', czyli 2

#2. Modyfikacje wartości pod danym kluczem
...
klucze = ['Bitwa pod Grumwaldem', 'Chrzest Polski', 'III Rozbiór Polski']
